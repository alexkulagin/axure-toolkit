		...
		!(function ()
		{
			...
			//┘
				...
				{	
					...
					/**
					 * Возвращает по имени виджет из конкретного состояния динамической панели
			...
			//┘
				...
				/**
				 * Создает контроллер динамической панели только при условии, что объект виджета 
				 * ссылается на одно представление с типом "dynamicPanel".
				 * 
				 * Если условие не выполняется — возвращает null
				 */
